...
type Identify struct {
	...
	Capabilities       int                 `json:"capabilities,omitempty"` // ADD THIS
	GuildSubscriptions bool                `json:"guild_subscriptions"`    // ADD THIS — no omitempty, must send false explicitly
}
